import { TgdConsole, TgdEvent, tgdCalcDegToRad, tgdCalcRadToDeg } from "@tolokoban/tgd"
...
export class LogicBalls {
    ...
    private wallsHitTest(ball: LogicBall) {
        ...
        const radius = LogicBalls.RADIUS
        if (dx > 0) {
