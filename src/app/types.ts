...
export type RoutePath =
    ...
    | "/05"
    | "/05/editor"
    | "/05/editor/[levelIndex]"
    | "/05/play"
    | "/06"

export function isRoutePath(path: string): path is RoutePath {
    return ["/","/01","/01/dead","/01/play","/02","/02/dead","/02/help","/02/play","/02/win","/03","/03/play","/04","/04/play","/04/win","/05","/05/editor","/05/editor/[levelIndex]","/05/play","/06"].includes(path)
}
