...
export type RoutePath =
    ...
    | "/06"
    | "/06/editor"
    | "/06/editor/[levelIndex]"
    | "/07"

export function isRoutePath(path: string): path is RoutePath {
    return ["/","/01","/01/dead","/01/play","/02","/02/dead","/02/help","/02/play","/02/win","/03","/03/play","/04","/04/play","/04/win","/05","/05/gameover","/05/play","/06","/06/editor","/06/editor/[levelIndex]","/07"].includes(path)
}
