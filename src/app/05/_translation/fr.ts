...
mais la tour de contrôle ne veut pas nous donner le feu vert pour le décollage.`,
	intro2: `Il semblerait que la météo des météorites soit mauvaise en ce moment,
et que les conditions de vol soient trop dangereuses.`,
	intro3: `En attendant, je te propose de faire un peu de ménage de façon ludique.`,
	intro4: `Dans les salles de cette base lunaire, il reste de nombreuses caisses inutilisées dont il faudrait se débarrasser.`,
	intro5: `Comme les salles ne sont pas pressurisées, on va envoyer un petit robot que tu télécommanderas.
Grâce à lui, tu pourras diriger une balle en métal sur les caisses pour les détruire.`,
	intro6: `Amuse-toi bien, et on te tient au courant de la météo.`,
	lifes: "Vies:",
	loading: "Chargement... ",
	start: `C'est parti !`,
