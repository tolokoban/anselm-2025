...
const FR = {
	...
	intro: `Désolé de te faire patienter Anselm,
...
En attendant, je te propose de faire un peu de ménage de façon ludique.

Dans les salles de cette base lunaire, il reste de nombreuses caisses inutilisées dont il faudrait se débarrasser.
Comme les salles ne sont pas pressurisées, on va envoyer un petit robot que tu télécommanderas.
